...
const superAdminNavItems: NavItem[] = [
  ...
  { label: 'Tests', href: '/super-admin/tests', icon: 'tests' },
  { label: 'Study Materials', href: '/super-admin/materials', icon: 'materials' },
  ...
  { label: 'Complaints', href: '/super-admin/complaints', icon: 'complaints' },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b border-white/10">
            <Link href="/super-admin" className="flex items-center space-x-3">
              ...
              />
              <span className="text-sm font-semibold leading-tight truncate">Super Admin</span>
            </Link>
          </div>
