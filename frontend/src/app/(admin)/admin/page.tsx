...
import { useAdminDashboard, AdminDashboardStats, useAggregatedDashboard } from '@/hooks/queries/useAdminQueries';
...
export default function AdminDashboard() {
  ...
  const stats = (data as any)?.stats as AdminDashboardStats | undefined;
