...
-- Global platform-level settings managed by the Super Admin
...
-- Seed default super admin settings (idempotent)
...
-- Audit log for super-admin visibility into admin actions
